    ...
    return (
        ...
        >
            <Box id="Error_Box_1" sx={styles.Error_Box_1}>
                <Typography dangerouslySetInnerHTML={{ __html: message.summary }} id="Error_Typography_1" sx={styles.Error_Typography_1} />
                {!skipLink && client !== undefined && client.baseUrl !== undefined && (
                    <Typography id="Error_Typography_2" sx={styles.Error_Typography_2}>
                        <Link href={client.baseUrl} id="Error_Link_1" sx={styles.Error_Link_1}>
