...
export default function LoginRecoveryAuthnCodeConfig(
    ...
    return (
        ...
        >
            <Box aria-label="Warning alert" id="LoginRecoveryAuthnCodeConfig_Box_1" sx={styles.LoginRecoveryAuthnCodeConfig_Box_1}>
                <Box id="LoginRecoveryAuthnCodeConfig_Box_2" sx={styles.LoginRecoveryAuthnCodeConfig_Box_2}>
                ...
                <Box id="LoginRecoveryAuthnCodeConfig_Box_3" sx={styles.LoginRecoveryAuthnCodeConfig_Box_3}>
                    <Typography id="LoginRecoveryAuthnCodeConfig_Typography_1" sx={styles.LoginRecoveryAuthnCodeConfig_Typography_1}>
            ...
            <ol id={olRecoveryCodesListId}>
                {recoveryAuthnCodesConfigBean.generatedRecoveryAuthnCodesList.map((code, index) => (
                    <ListItem key={index} id="LoginRecoveryAuthnCodeConfig_ListItem_1" sx={styles.LoginRecoveryAuthnCodeConfig_ListItem_1}>
                        <span id="LoginRecoveryAuthnCodeConfig_span_2">{index + 1}:</span> {code.slice(0, 4)}-{code.slice(4, 8)}-{code.slice(8)}
                    </ListItem>
                ))}
            </ol>

            {/* actions */}
            <Box id="LoginRecoveryAuthnCodeConfig_Box_4" sx={styles.LoginRecoveryAuthnCodeConfig_Box_4}>
                <Button type="button" id="LoginRecoveryAuthnCodeConfig_Button_1" sx={styles.LoginRecoveryAuthnCodeConfig_Button_1}>
                    <i id="LoginRecoveryAuthnCodeConfig_i_2" aria-hidden="true" /> {msg("recovery-codes-print")}
                </Button>
                <Button type="button" id="LoginRecoveryAuthnCodeConfig_Button_2" sx={styles.LoginRecoveryAuthnCodeConfig_Button_2}>
                    <i id="LoginRecoveryAuthnCodeConfig_i_3" aria-hidden="true" /> {msg("recovery-codes-download")}
                </Button>
                <Button type="button" id="LoginRecoveryAuthnCodeConfig_Button_3" sx={styles.LoginRecoveryAuthnCodeConfig_Button_3}>
                    <i id="LoginRecoveryAuthnCodeConfig_i_4" aria-hidden="true" /> {msg("recovery-codes-copy")}
                </Button>
            </Box>

            {/* confirmation checkbox */}
            <Box id="LoginRecoveryAuthnCodeConfig_Box_5" sx={styles.LoginRecoveryAuthnCodeConfig_Box_5}>
                <Checkbox
            ...
            >
                ...
                />
                <input id="LoginRecoveryAuthnCodeConfig_input_3" type="hidden" name="generatedAt" value={recoveryAuthnCodesConfigBean.generatedAt} />
                <input type="hidden" id="userLabel" name="userLabel" value={msgStr("recovery-codes-label-default")} />

                <LogoutOtherSessions id="LoginRecoveryAuthnCodeConfig_LogoutOtherSessions_1" kcClsx={kcClsx} i18n={i18n} />
...
function LogoutOtherSessions(props: { id: string; kcClsx: KcClsx; i18n: I18n }) {
    ...
    const { msg } = i18n;
    return (
        <Box id="LoginRecoveryAuthnCodeConfig_Box_7" sx={styles.LoginRecoveryAuthnCodeConfig_Box_7}>
            <FormLabel id="LoginRecoveryAuthnCodeConfig_FormLabel_2" sx={styles.LoginRecoveryAuthnCodeConfig_FormLabel_2}>
                <Checkbox
