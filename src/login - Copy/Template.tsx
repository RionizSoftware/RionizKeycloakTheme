...
import { Box, Button, Link, TextField, FormLabel, Typography, List, ListItem, MenuItem, Menu } from "@mui/material";
                ...
                {auth !== undefined && auth.showTryAnotherWayLink && (
                    <Box action={url.loginAction} method="post" component="form" id="Template_Box_8" sx={styles.Template_Box_8}>
                        <Box id="Template_Box_9" sx={styles.Template_Box_9}>
                            <TextField type="hidden" name="tryAnotherWay" value="on" id="Template_TextField_1" sx={styles.Template_TextField_1} />
                            <Link
                                href="#"
                                onClick={() => {
