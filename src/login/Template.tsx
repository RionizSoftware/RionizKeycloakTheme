        ...
        <Box id="Box_1" sx={styles.Box_1}>
            ...
            <header>
                    ...
                    <Box id="Box_2" sx={styles.Box_2}>
                        ...
                        >
                            {locale.supported.map(({ languageTag }, i) => (
                                <ListItem key={languageTag} role="none" id="ListItem_1" sx={styles.ListItem_1}>
                                    <Link role="menuitem" href={getChangeLocaleUrl(languageTag)} id="Link_1" sx={styles.Link_1}>
                ...
                {(() => {
                    const node = !(auth !== undefined && auth.showUsername && !auth.showResetCredentials) ? (
                        <Typography variant="h1" component="h1" id="Typography_1" sx={styles.Typography_1}>
                            {headerNode}
                        </Typography>
                    ) : (
                        <Box id="Box_3" sx={styles.Box_3}>
                            ...
                            <Link href={url.loginRestartFlowUrl} aria-label={msgStr("restartLoginTooltip")} id="Link_2" sx={styles.Link_2}>
            ...
            <Box id="Box_6" sx={styles.Box_6}>
                ...
                {auth !== undefined && auth.showTryAnotherWayLink && (
                    <Box action={url.loginAction} method="post" component="form" id="Box_8" sx={styles.Box_8}>
                        <Box id="Box_9" sx={styles.Box_9}>
                            <TextField type="hidden" name="tryAnotherWay" value="on" id="TextField_1" sx={styles.TextField_1} />
                            <Link
                                href="#"
                                onClick={() => {
