                ...
                <>
                    {realm.password && social?.providers !== undefined && social.providers.length !== 0 && (
                        <Box id="Box_2" sx={styles.Box_2}>
                            <hr />
                            <Typography variant="h2" component="h2" id="Typography_1" sx={styles.Typography_1}>
                                {msg("identity-provider-login-label")}
                            </Typography>
                            <List id="List_1" sx={styles.List_1}>
                                {social.providers.map((...[p, , providers]) => (
                                    <ListItem key={p.alias} id="ListItem_1" sx={styles.ListItem_1}>
                                        <Link type="button" href={p.loginUrl} id="Link_2" sx={styles.Link_2}>
                    ...
                    >
                        {!usernameHidden && (
                            <Box id="Box_5" sx={styles.Box_5}>
                                <FormLabel htmlFor="username" id="FormLabel_1" sx={styles.FormLabel_1}>
